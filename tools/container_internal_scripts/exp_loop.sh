...
do
    ...
    do
        ...
        then
            ...
            python ~/git/semantic-assembler/tools/exp_run.py +exp.agent_model_path=/home/jayp/git/semantic-assembler/assets/agent_models/color_pretrained.ckpt exp.task=$3 exp.player_type=${pl_type} vision.calibrate_camera=false seed=$seed
            # Comment above and uncomment below before pushing to docker hub
